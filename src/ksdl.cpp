...
void KSDL::drawDEBUGSquares() {
    ...
    SDL_FillRect(this->screen_surface, &rect, SDL_MapRGB(this->screen_surface->format, 0xFF, 0x00, 0x00));

    SDL_Rect rect2{this->screen_surface->w - 64, this->screen_surface->h - 64, 32, 32};
    SDL_FillRect(this->screen_surface, &rect2, SDL_MapRGB(this->screen_surface->format, 0x00, 0xFF, 0x00));

    SDL_Rect rect3{this->screen_surface->w - 64, 32, 32, 32};
    SDL_FillRect(this->screen_surface, &rect3, SDL_MapRGB(this->screen_surface->format, 0x00, 0x00, 0xFF));

    SDL_Rect rect4{32, this->screen_surface->h - 64, 32, 32};
    SDL_FillRect(this->screen_surface, &rect4, SDL_MapRGB(this->screen_surface->format, 0xFF, 0xFF, 0x00));
}
